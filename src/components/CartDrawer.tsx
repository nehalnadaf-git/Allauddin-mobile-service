                ...
                <>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 py-4 flex-shrink-0">
                            ...
                            <button
                                onClick={closeCart}
                                className="w-9 h-9 rounded-full flex items-center justify-center text-blue-grey transition-colors"
                                            ...
                                            <div key={item.id} className="space-y-1.5">
                                                ...
                                                <div
                                                    ...
                                                    style={{
                                                        background: isService
                                                            ? "linear-gradient(135deg, rgba(26,16,53,0.04), rgba(45,27,105,0.06))"
                                                            : "rgba(0,0,0,0.02)",
                                                        border: isService
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        {/* Type chip */}
                                                        <span
                                                            className="inline-block font-poppins font-bold text-[9px] uppercase tracking-wider px-1.5 py-0.5 rounded mb-0.5"
                                                            style={
                                                                isService
                                                        ...
                                                        >
                                                            {isService ? "🔧 Repair" : "📦 Accessory"}
                                                        </span>
                                                        <p className="font-dm font-medium text-sm text-[#0F0F0F] truncate leading-tight">{item.name}</p>
                                                        <p className="font-poppins font-bold text-sm text-[#7C3AED]">
                                                            {isService
                                                                ? (item.startingPrice ? `from ₹${item.startingPrice}` : "Price on diagnosis")
                                                    ...
                                                    {!isService && (
                                                        <div className="flex items-center gap-1">
                                                            <button
                                                                ...
                                                                className="w-7 h-7 rounded-full flex items-center justify-center text-[#7C3AED] hover:text-white transition-colors hover:bg-[#7C3AED]"
                                                                style={{ background: "rgba(124,58,237,0.08)" }}
                                                                aria-label="Decrease"
                                                            >
                                                                <Minus size={12} />
                                                            </button>
                                                            <span className="w-7 text-center font-poppins font-semibold text-sm text-[#0F0F0F]">
                                                                {item.quantity}
                                                            </span>
                                                            <button
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1.5 text-blue-grey hover:text-error transition-colors"
                                                ...
                                                {/* BOGO Free Item Row */}
                                                {freeItem && (
                                                    <div className="flex items-center gap-3 p-3 bg-success/8 border border-success/20 rounded-xl ml-2">
                                                        <div className="w-12 h-12 rounded-lg bg-success/10 flex items-center justify-center flex-shrink-0">
                                                            <Gift size={16} className="text-success" />
                                                        </div>
                                                        <div className="flex-1 min-w-0">
                                                            <p className="font-dm font-medium text-sm text-[#0F0F0F] truncate italic">{freeItem.name}</p>
                                                            <div className="flex items-center gap-2">
                                                                <span className="bg-success text-white text-[10px] font-poppins font-bold px-1.5 py-0.5 rounded">
                                                                    FREE
                                                                </span>
                                                                <span className="font-poppins font-bold text-sm text-success">₹0</span>
                                                            </div>
                                                        </div>
                                                        <span className="text-xs text-muted font-dm">x{freeItem.quantity}</span>
                                                    </div>
                                                )}
                                            </div>
                                        );
                        ...
                        {paidItems.length > 0 && (
                            <div className="flex-shrink-0">
                                ...
                                <div className="px-5 py-4 space-y-3">
                                    ...
                                    <div className="space-y-1.5">
                                        {hasServices && (
                                            <div className="flex items-center justify-between">
                                                <span className="font-dm text-[#6B7280] text-xs flex items-center gap-1">
                                                    🔧 Repair — price confirmed at shop
                                                </span>
                                            </div>
                                        )}
                                        {accessoriesTotal > 0 && (
                                            <div className="flex items-center justify-between">
                                                <span className="font-dm text-[#6B7280] text-sm">
                                                    📦 Accessories Total
                                                </span>
                                    ...
                                    <button
                                        onClick={clearCart}
                                        className="w-full py-2 text-blue-grey hover:text-error text-sm font-dm transition-colors"
                                    >
                                        Clear Cart
                                    </button>
                                </div>
